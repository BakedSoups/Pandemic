...
func update_text(message):
	...
	if Data.dict_names.has("SF"):
		print("SF data only:")
		print(Data.dict_names["SF"])

		# If you want just the SIR history
		print("SF SIR history:")

		Data.Current_S = Data.dict_names["SF"]["sir_history"][0]
		Data.Current_I = Data.dict_names["SF"]["sir_history"][1]
		Data.Current_R = Data.dict_names["SF"]["sir_history"][2]
		
	else:
		print("SF not found in dictionary")
